...
def pretrain_model(model_name, dataset_path, save_file_path): 
...
def train_with_pretrained_model_and_save_best(dataset_path = "data/public_data/train/track_a/eng.csv", model_to_pretrain = None, pretrained_model = None, extend_dataset = False, freeze_layers = False, freeze_to_layer = 12, loRa = False): 
    ...
    if freeze_layers: 
        for param in model.model.encoder.layer[:freeze_to_layer-1].parameters(): 
...
if __name__ == "__main__": 
    ...
    train_with_pretrained_model_and_save_best(pretrained_model = "./results/pretraining/roberta-base_2025-01-03_17-14-47/best_model")
